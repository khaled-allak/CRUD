        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (status == 'true') {
              ...
              // table.cell(parseInt(trid) - 1,1).data(product);
              // table.cell(parseInt(trid) - 1,2).data(category);
              // table.cell(parseInt(trid) - 1,3).data(mobile);
              // table.cell(parseInt(trid) - 1,4).data(city);
              var button = '<td><a href="javascript:void();" data-id="' + id + '" class="btn btn-info btn-sm editbtn">Edit</a>  <a href="#!"  data-id="' + id + '"  class="btn btn-danger btn-sm deleteBtn">Delete</a></td>';
              var row = table.row("[id='" + trid + "']");
              row.row("[id='" + trid + "']").data([id, product, category, button]);
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="category" class="form-control" id="categoryField" name="category">
              </div>
            </div>
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="category" class="form-control" id="addcategoryField" name="category">
              </div>
            </div>
            <div class="text-center">
              <button type="submit" class="btn btn-primary">Submit</button>
